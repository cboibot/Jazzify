...
The composition engine organizes melodic material as recurring A, A', B and A'' motif phrases. Motifs use scale-shaped contours, inverted development, controlled chromatic approach notes, swing placement, phrase-level velocity curves, and small timing/duration variance. Ensembles share the idea, harmony and section plan: bass and drums sit beneath the lead, piano comps and answers, while additional horns or guitar enter later as lower counter-lines rather than mechanical unison doubles. A single selected instrument receives a dedicated solo arrangement: piano adds left-hand motion and an upper voice, guitar alternates comping and melody, solo horns phrase with space, bass shapes walking phrases, and drums use form changes and fills.
